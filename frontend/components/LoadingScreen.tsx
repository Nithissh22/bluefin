...
export default function LoadingScreen({ fullScreen = false }: { fullScreen?: boolean }) {
    ...
    const containerClasses = fullScreen 
        ? "fixed inset-0 z-[100] flex items-center justify-center bg-background/95 backdrop-blur-xl overflow-hidden"
        : "w-full min-h-[400px] flex items-center justify-center flex-col py-12 overflow-hidden";
        ...
        <div className={containerClasses}>
            <div className="relative flex flex-col items-center justify-center">
                <div className="relative w-64 h-64 flex items-center justify-center">
                    ...
                    <svg viewBox="0 0 100 120" className="w-40 h-48 z-10 overflow-visible">
                        ...
                        <path d="M 38 10 L 38 40 L 18 95 C 13 105 18 110 28 110 L 72 110 C 82 110 87 105 82 95 L 62 40 L 62 10 Z" fill="rgba(255,255,255,0.02)" />
                        ...
                        <g clipPath="url(#beakerClip)">
                            ...
                            {bubbles.map(b => (
                                <circle 
                                    key={`bubble-${b.id}`}
                                    cx={b.x} cy="110" r={b.size / 2} fill="rgba(255,255,255,0.8)"
                        ...
                        <path d="M 40 10 L 40 40 L 20 95 C 15 105 20 110 30 110 L 70 110 C 80 110 85 105 80 95 L 60 40 L 60 10" fill="none" stroke="hsl(var(--foreground))" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" filter="url(#glow)"/>
            ...
            <style>{`
                ...
                @keyframes liquid-wave {
                    0% { d: path("M 0 65 Q 25 55 50 65 T 100 65 L 100 120 L 0 120 Z"); }
                    50% { d: path("M 0 60 Q 25 70 50 60 T 100 60 L 100 120 L 0 120 Z"); }
                    100% { d: path("M 0 65 Q 25 55 50 65 T 100 65 L 100 120 L 0 120 Z"); }
                }
                ...
                .animate-liquid-wave { animation: liquid-wave 3s ease-in-out infinite; }
                .animate-bubble { animation: bubble-rise linear infinite; }
            `}</style>
        </div>
    );
}
